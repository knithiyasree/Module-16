...
## OUTPUT
<img width="397" height="93" alt="image" src="https://github.com/user-attachments/assets/f7b0b6a0-b303-41bf-adc7-ea00c03bc019" />

## RESULT
Thus a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element '7' into it has been executed successfully.
